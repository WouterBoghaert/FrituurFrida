...
import be.vdab.repositories.ZoekDeFrietRepositoryVerkeerd;

@WebServlet("/zoekDeFrietVerkeerd.htm")
public class ZoekDeFrietServletVerkeerd extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final String VIEW = "/WEB-INF/JSP/zoekdefrietverkeerd.jsp";
	private ZoekDeFrietRepositoryVerkeerd zoekDeFrietRepository = new ZoekDeFrietRepositoryVerkeerd();
...
//	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("nieuwSpel") != null) {
			zoekDeFrietRepository = new ZoekDeFrietRepositoryVerkeerd();
			HttpSession session = request.getSession();
			session.removeAttribute("geklikt");
		}
